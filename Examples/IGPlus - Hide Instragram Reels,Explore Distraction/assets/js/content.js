...
(()=>{{let a,t,n,i,o,r,s,l,p=["noto_sans","pixelify","montserrat","poppins","merriweather","nunito","gabarito","playfair","roboto","roboto_condensed","caprasimo","inter"],c=chrome||browser;document.documentElement.style.opacity=0;let d;function u(e,n,a){fetch(c.runtime.getURL(e)).then(e=>e.text()).then(e=>{var t=document.getElementById(a),o=document.createElement("style");o.textContent=e,o.setAttribute("id",a),n&&!t?document.head.appendChild(o):!n&&t instanceof Node&&document.head.removeChild(t)}).catch(e=>{})}function m(e){clearInterval(t),u("/assets/graphs/disable_vanity.css",e,"disable_vanity"),e?t=setInterval(function(){e&&document.querySelectorAll("button._a9ze")?.forEach(e=>{var t=e.innerText;isNaN(t[0])&&isNaN(t[t.length-1])||e.classList.add("hide_ls2")})},300):clearInterval(t)}function f(t,o){clearInterval(n),u("/assets/graphs/disable_explore.css",t,"disable_explore"),t?n=setInterval(function(){var e;window.innerWidth<768||t&&window.location.href.includes("/explore")&&(e=o?"/?variant=following":"/",window.location?.assign?window.location.assign(e):window.location.href=e,console.log("IGPlus: Redirect"),clearInterval(n))},300):clearInterval(n)}function g(t,o){clearInterval(i),u("/assets/graphs/disable_reels.css",t,"disable_reels"),t?i=setInterval(function(){var e;t&&window.location.href.includes("/reels")&&(e=o?"/?variant=following":"/",window.location?.assign?window.location.assign(e):window.location.href=e,console.log("IGPlus: Redirect"),clearInterval(i))},300):clearInterval(i)}function x(e,t){clearInterval(o),u("/assets/graphs/ev_disable_stories.css",e,"ev_disable_stories"),u("/assets/graphs/mp_disable_stories.css",t,"mp_disable_stories"),e?o=setInterval(function(){e&&window.location.href.includes("/stories/")&&(window.location?.assign?window.location.assign("/"):window.location.href="/",console.log("IGPlus: Redirect"),clearInterval(o))},300):clearInterval(o)}function h(e){clearInterval(r),e?r=setInterval(function(){document.querySelectorAll('a[href="/"]')?.forEach(e=>{e.setAttribute("href","/?variant=following"),e.addEventListener("click",function(e){e.preventDefault(),e.stopImmediatePropagation(),"https://www.instagram.com/?variant=following"!==window.location.href&&(window.location.href="https://www.instagram.com/?variant=following")},!0)}),e&&("https://www.instagram.com/"===window.location.href||-1<window.location.href.indexOf("?variant=home"))&&(window.location?.assign?window.location.assign("/?variant=following"):window.location.href="/?variant=following",clearInterval(r))},300):(clearInterval(r),document?.querySelectorAll('a[href="/?variant=following"]')?.forEach(e=>e.setAttribute("href","/")))}function _(e){function t(){e&&("https://www.instagram.com/"===window.location.href||-1<window.location.href.indexOf(".com/?variant=")||-1<window.location.href.indexOf(".com/reels")||-1<window.location.href.indexOf(".com/explore"))&&-1===window.location.href.indexOf("/direct/")&&(clearInterval(l),window.location?.assign?window.location.assign("/direct/inbox/"):window.location.href="/direct/inbox/")}clearInterval(l),e?l=setInterval(t,300):clearInterval(l)}function b(e){clearInterval(s),u("/assets/graphs/block_videos.css",e,"block_videos"),e?s=setInterval(function(){e&&document.querySelectorAll("article").forEach(e=>{var t=e.querySelector("video");t&&(e.classList.add("video"),t.remove())})},300):clearInterval(s)}function v(){c.storage.local.get("formState",e=>{let t=e.formState.disabled?{a:!0}:e.formState;var o,n;["mp_disable_feed","disable_comments","disable_notes","block_images","counters_gray","counters_disable","grayscale","disable_threads"].forEach(e=>{u(`/assets/graphs/${e}.css`,t[e],e)}),e="/assets/graphs/classic_mode.css",o=t.classic_mode,clearInterval(a),u(e,o,"classic_mode"),o?a=setInterval(function(){},200):clearInterval(a),m(t.disable_vanity),f(t.disable_explore,t.mp_disable_recs),g(t.disable_reels,t.mp_disable_recs),b(t.block_videos),x(t.ev_disable_stories,t.mp_disable_stories),t.nav_to_messages_first||h(t.mp_disable_recs),_(t.nav_to_messages_first),u("/assets/graphs/square_shaped.css",t.square_shaped,"square_shaped"),n=t.font,-1!==p.indexOf(n)&&u(`/assets/graphs/fonts/${n}.css`,!0,n),p.filter(e=>e!==n).forEach(e=>document.getElementById(e)?.remove())}),setTimeout(()=>{document?.body?.style?.opacity&&(document.body.style.opacity="all 0s!important"),document?.documentElement?.style?.opacity&&(document.documentElement.style.opacity=1)},300)}var e;c.storage.local.onChanged.addListener((e,t)=>{e.formState&&e.formState.newValue&&JSON.stringify({...e.formState.newValue})!==d&&(d=JSON.stringify({...e.formState.newValue}),v())}),c.storage.local.onChanged.addListener((e,t)=>{e.formState&&e.formState.newValue&&e.formState.oldValue&&JSON.stringify({...e.formState.newValue})!==JSON.stringify({...e.formState.oldValue})&&v({...e.formState.oldValue})}),v(),e=0,document.addEventListener("DOMContentLoaded",()=>{document.body.style.opacity=0,setTimeout(()=>document.body.style.opacity=1,e)}),document.addEventListener("DOMContentLoaded",v,!1)}})(),(()=>{let o;function t(){console.log("injectButton");var e,t=document.querySelector(".xl5mz7h.xhuyl8g");t&&!t.querySelector("#b705b0e5b14434a529cff55fd61131489")&&(o&&o.disconnect(),(e=document.createElement("section")).classList.add("x1azxncr"),e.innerHTML=`
  ...
  <div class="spp__popup-container">
   <div class="logo">
    ...
    <p class="spp__sup">${i[a].sup} 
    
    ❤️

    <div class="close-popup2">
      <a class="closeNotification">${i[a].rem_btn}</a>
      <a href="https://github.com/ptjaworski/IGPlus-extension/blob/main/README.md" target="_blank">${i[a].more_btn}</a>
    </div>
  </div>
...
<style id="43ggfdbt5rf">
  ...
  .close-popup2 {
    ...
    margin-bottom: 5px;
            ...
            `;setTimeout(()=>{document.body.appendChild(t);var e=document.querySelectorAll(".closeNotification"),e=(e&&e?.forEach(e=>e.addEventListener("click",function(){t.style.display="none"})),r.storage.local.set({closeDonateCount:1+(isNaN(n.closeDonateCount)?0:+n.closeDonateCount)}),"string"==typeof o?.formState?.theme&&r.storage.local.set({formState:{...o.formState,timestamp:Date.now()}}),document.querySelectorAll(".donate-btn"));e.length&&e.forEach(e=>e.addEventListener("click",function(){r.storage.local.set({closeDonateCount:3})}))},24e4)}})})},!1)}})();