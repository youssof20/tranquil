    ...
    for (const element of contentElements) {
      if (
        ((element.querySelector("#thumbnail") ||
          element.tagName.toLowerCase() === "ytd-channel-renderer") &&
          element.tagName.toLowerCase() !== "ytd-watch-metadata") ||
        element.tagName.toLocaleLowerCase() === "ytd-rich-item-renderer" ||
        element.tagName.toLocaleLowerCase() === "yt-lockup-view-model"
      ) {
        ...
        element.tagName.toLowerCase() == "ytd-comment-thread-renderer"
      ) {
